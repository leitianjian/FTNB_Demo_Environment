...
public class DatabaseUtil {
    ...
    private static String dbUrl = "jdbc:mysql://localhost:3306/fantainb?useUnicode=true&characterEncoding=utf-8&serverTimezone=UTC";// 数据库地址
    ...
    public static void updateLocation(String message) throws SQLException {
...
//        INSERT INTO `sy_userinfo` VALUES ('admin','管理员','admin',NULL,NULL,1,1)
    ...
    public static HashSet<LocationInfo> retrieveLocation() {
        try {
            if (connection == null || connection.isClosed()) {
                connection = getConnection();
            }
